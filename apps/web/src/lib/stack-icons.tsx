...
/**
 * TanStack — official brand mark: six-arm red asterisk with yellow hexagon center.
 * Colors: #FF4154 (red arms) + #FFD94C (yellow hexagon).
 * Paths extracted from tanstack/router media/logo.svg, scaled to 190×165 space.
 */
function TanStackIcon({ size = 20 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={{ display: "block", flexShrink: 0 }}
    >
      {/* Outer six-arm asterisk — red */}
      <path
        fill="#FF4154"
        d="M54.86 98.36c1.31-.75 2.98-.28 3.72 1.04l.47.84c3.8 6.74 7.77 13.14 11.89 19.19 4.87 7.15 10.34 14.39 16.42 21.72.95 1.15.82 2.86-.3 3.85l-.61.54C66.35 163.1 53.28 166.61 47.25 156.06c-5.9-10.32-3.77-29.08 6.4-56.28.22-.6.65-1.11 1.21-1.42zM140.53 119.04c1.45-.26 2.84.7 3.13 2.15l.15.79c4.97 26.01 1.47 39.02-10.5 39.02-11.71 0-26.61-11.09-44.71-33.27-.4-.49-.62-1.11-.61-1.74.01-1.5 1.24-2.71 2.73-2.7l.95.01c7.62.04 15.03-.22 22.22-.79 8.5-.67 17.37-1.83 26.62-3.46zM147.41 63.81c.52-1.41 2.1-2.15 3.54-1.66l.79.27c25.84 8.8 35.66 18.47 29.45 29.02-6.07 10.31-23.72 17.82-52.94 22.52-.65.1-1.31-.02-1.88-.35-1.34-.77-1.78-2.46-.99-3.77l.5-.84c3.99-6.69 7.59-13.35 10.81-19.98 3.8-7.83 7.37-16.23 10.71-25.21zM61.74 56.04c.65-.1 1.31.02 1.88.34 1.33.77 1.78 2.46.99 3.77l-.5.84c-3.99 6.69-7.59 13.35-10.81 19.98C49.49 88.81 45.93 97.21 42.59 106.19c-.52 1.41-2.1 2.15-3.54 1.66l-.79-.27C12.42 98.78 2.6 89.11 8.8 78.56c6.07-10.31 23.72-17.82 52.94-22.52zM103.55 24.47C123.65 6.9 136.72 3.39 142.75 13.94c5.9 10.32 3.77 29.08-6.4 56.28-.22.6-.65 1.1-1.21 1.42-1.31.75-2.98.28-3.74-1.04l-.47-.84c-3.8-6.74-7.77-13.14-11.89-19.19C114.19 43.41 108.72 36.18 102.64 28.85c-.95-1.15-.82-2.86.3-3.85l.61-.53zM57.68 8c11.71 0 26.61 11.09 44.71 33.27.4.49.62 1.11.61 1.74-.01 1.5-1.24 2.71-2.73 2.7l-.95-.01c-7.62-.04-15.03.22-22.22.79C68.59 47.17 59.72 48.33 50.47 49.96c-1.45.26-2.84-.7-3.13-2.15l-.15-.79C42.22 21 45.72 8 57.68 8z"
      />
      {/* Inner segmented hexagon — yellow */}
      <path
        fill="#FFD94C"
        d="M76.11 91l13.51 24H80.4c-1.79 0-3.45-.96-4.34-2.51L69.95 101.83 76.11 91zM118.81 104l-4.87 8.49C113.05 114.04 111.4 115 109.61 115H97.18L91 104h27.81zM103 71l8 13.54L103.05 98H87.01L79 84.38 86.96 71H103zM124.14 74.27l4.44 7.74c.88 1.54.88 3.44 0 4.98L122.26 98H110l14.14-23.73zM80 72L66.13 95.19l-4.71-8.2c-.88-1.54-.88-3.44 0-4.98L67.17 72H80zM109.61 54c1.79 0 3.45.96 4.34 2.51l6.89 12.01L114.93 79 100.82 54h8.79zM93.77 54L100 65H71.19l4.87-8.49C77.95 54.96 79.61 54 81.4 54h12.37z"
      />
    </svg>
  )
}
...
/**
 * Vite — official Simple Icons path (lightning bolt). Brand color #646CFF.
 */
function ViteIcon({ size }: { size?: number }) {
  return (
    <I size={size} title="Vite">
      <path
        fill="#646CFF"

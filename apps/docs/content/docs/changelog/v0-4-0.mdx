...
description: Adds TanStack Start and Vite React frontends, six new auth slices, a Vite shadcn/ui slice, and nine bug fixes.
---

import { Callout } from 'fumadocs-ui/components/callout'

<Callout type="info">This version is **upcoming** — pending changeset publish.</Callout>
